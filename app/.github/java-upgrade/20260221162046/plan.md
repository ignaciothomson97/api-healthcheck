...
## Project Information
- **Project path**: /home/ignaciothomson/Escritorio/Java/api-healthcheck/app
- **Working branch**: appmod/java-upgrade-20260221162046
...
- **Source JDK path (Java 17)**: /home/ignaciothomson/.jdk/jdk-17.0.16/bin
- **Target JDK path (Java 21)**: <span style="color:red"><to be installed, or specify the path here></span>
- **Build tool type**: Maven
- **Build tool path**: /home/ignaciothomson/.maven/maven-3.9.12/bin
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20260221162046`.
